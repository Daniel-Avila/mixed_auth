    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_ldap', models.BooleanField(verbose_name='LDAP User', default=False, editable=False)),
                ('groups', models.ManyToManyField(related_query_name='user', related_name='user_set', help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', verbose_name='groups', blank=True, to='auth.Group')),
